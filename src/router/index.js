    ...
    children: [
      {
        ...
        component: () =>
          import("../views/enter-login/enter/detail/PersonalSetting.vue"),
        children: [
          {
            path: "self",
            name: "self",
            component: () =>
              import(
                "../views/enter-login/enter/detail/person-setting/Self.vue"
              ),
          },
          {
            path: "safe",
            ...
            component: () =>
              import(
                "../views/enter-login/enter/detail/person-setting/Safe.vue"
              ),
          },
          {
            path: "company",
            ...
            component: () =>
              import(
                "../views/enter-login/enter/detail/person-setting/Company.vue"
              ),
          },
          {
            path: "group",
            ...
            component: () =>
              import(
                "../views/enter-login/enter/detail/person-setting/Group.vue"
              ),
          },
        ],
      },
    ...
    children: [
      {
        path: "post",
        name: "post",
        component: () => import("../views/enter-login/turn/detail/Post.vue"),
        children: [
          {
            path: "post-news",
            name: "post-news",
            component: () =>
              import("../views/enter-login/turn/detail/post/PostNews.vue"),
          },
          {
            path: "group",
            name: "post-group",
            component: () =>
              import("../views/enter-login/turn/detail/post/Group.vue"),
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            component: () =>
              import(
                "../views/enter-login/turn/detail/person/OriginalResume.vue"
              ),
          },
          {
            ...
            component: () =>
              import(
                "../views/enter-login/turn/detail/person/StandardResume.vue"
              ),
          },
          {
            ...
            component: () =>
              import(
                "../views/enter-login/turn/detail/person/CandidatePortrait.vue"
              ),
          },
        ],
      },
